...
export default function Home() {
  ...
  return(
    <> 
        <header className="z-index-100 position-fixed left-0-px right-0-px height-125-px display-flex align-items-center justify-content-center">
            <div className="width-100-percent padding-left-40-px padding-right-40-px display-flex align-items-center justify-content-space-between">
        ...
        <main>
            <section className="height-30-px position-relative top-125-px">
